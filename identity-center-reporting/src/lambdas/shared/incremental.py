...
class IncrementalDiscoveryManager:
    ...
    def detect_instance_changes(self, current_instances: List[Dict[str, Any]], 
        ...
        try:
            ...
            existing_instances = {item['instance_arn']: item for item in scan_all(self.instances_table)}
    ...
    def detect_application_changes(self, current_applications: List[Dict[str, Any]], 
        ...
        try:
            ...
            existing_applications = {item['application_arn']: item for item in scan_all(self.applications_table)}
    ...
    def detect_assignment_changes(self, current_assignments: List[Dict[str, Any]], 
        ...
        try:
            ...
            existing_assignments = {item['assignment_id']: item for item in scan_all(self.assignments_table)}
        ...
        for change in changes:
            if change.resource_type == 'instance':
                ...
                try:
                    ...
                    print(f"Error getting applications for instance {change.resource_id}: {str(e)}")
                ...
                try:
                    ...
                    print(f"Error getting assignments for application {change.resource_id}: {str(e)}")
    ...
    def create_incremental_discovery_plan(self, discovery_run_id: str) -> Dict[str, Any]:
        ...
        selected. No caller narrows anything on the basis of this plan --
        change-detection logs it and returns it in the response body, and
        nothing reads the scope fields -- so the label was the only thing
        claiming an optimization existed.
